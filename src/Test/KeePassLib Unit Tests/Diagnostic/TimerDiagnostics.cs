...
namespace KeePassLib_Unit_Tests.Diagnostic
{
    public static class TimerDiagnosticsExtensions
    {
        /// <summary>
        ...
        /// <param name="self"></param>
        /// <returns></returns>
        public static int ToMicroseconds(TimeSpan self)
        {
            return (int)Math.Floor((self.Ticks % TimeSpan.TicksPerMillisecond) / (double)TicksPerMicrosecond);
        }
        /// <summary>
        ...
        /// <param name="self">The DateTime object.</param>
        /// <returns>the number of Nanoseconds.</returns>
        public static int ToNanoseconds(TimeSpan self)
        {
            return (int)(self.Ticks % TimeSpan.TicksPerMillisecond % TicksPerMicrosecond) * NanosecondsPerTick;
        }
    ...
    public static class DateTimeExtensionMethods
    {
        ...
        /// <param name="self"></param>
        /// <returns></returns>
        public static int ToMicroseconds(DateTime self)
        {
            return (int)Math.Floor((self.Ticks % TimeSpan.TicksPerMillisecond) / (double)TicksPerMicrosecond);
        }
        /// <summary>
        ...
        /// <param name="self">The DateTime object.</param>
        /// <returns>the number of Nanoseconds.</returns>
        public static int ToNanoseconds(DateTime self)
        {
            return (int)(self.Ticks % TimeSpan.TicksPerMillisecond % TicksPerMicrosecond) * NanosecondsPerTick;
        }
        /// <summary>
